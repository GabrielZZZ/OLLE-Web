...
&nbsp;&nbsp;&nbsp; Forum</p>
    <p>&nbsp;<asp:ImageButton ID="ImageButton2" runat="server" AlternateText="Forum" Height="73px" ImageUrl="~/Images/calendar.png" Width="73px" />
        &nbsp;&nbsp;&nbsp; Calendar</p>
    <p>&nbsp;<asp:ImageButton ID="ImageButton3" runat="server" AlternateText="Forum" Height="73px" ImageUrl="~/Images/main_page.png" Width="73px" />
        &nbsp;&nbsp;&nbsp; Training</p>
    <p>&nbsp;<asp:ImageButton ID="ImageButton4" runat="server" AlternateText="Forum" Height="73px" ImageUrl="~/Images/forum.png" Width="73px" />
        &nbsp;&nbsp;&nbsp; Announcement</p>
    <p>&nbsp;<asp:ImageButton ID="ImageButton5" runat="server" AlternateText="Forum" Height="73px" ImageUrl="~/Images/setting.png" Width="73px" />
        &nbsp;&nbsp;&nbsp; Troubleshoot</p>
    <p>&nbsp;<asp:ImageButton ID="ImageButton6" runat="server" AlternateText="Forum" Height="73px" ImageUrl="~/Images/forum.png" Width="73px" />
        &nbsp;&nbsp;&nbsp; Feedback</p>
